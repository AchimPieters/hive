...
ANTHIAS_RELEASE_URL="https://github.com/HIVE/releases"
...
function build_qt () {
    ...
    mkdir -p fakeroot/bin fakeroot/share/HIVEWebview
    mv HIVEWebview fakeroot/bin/
    cp -rf /webview/res fakeroot/share/HIVEWebview/

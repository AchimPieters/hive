...
> [!NOTE]
> The list is not exhaustive, but you can use it as your guide when testing HIVE.
...
3. Disable the assets and make sure that the screen in standby mode, which means that it displays the HIVE standby page.

...
<p align="center">
  <a href="https://github.com/AchimPieters/HIVE/actions/workflows/docker-test.yaml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/HIVE/docker-test.yaml?branch=master&style=for-the-badge&label=Run%20Unit%20Tests" alt="Run Unit Tests"></a>
  <a href="https://github.com/AchimPieters/HIVE/actions/workflows/codeql-analysis.yaml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/HIVE/codeql-analysis.yaml?branch=master&style=for-the-badge&label=CodeQL" alt="CodeQL"></a>
  <a href="https://github.com/AchimPieters/HIVE/actions/workflows/python-lint.yaml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/HIVE/python-lint.yaml?branch=master&style=for-the-badge&label=Run%20Python%20Linter" alt="Run Python Linter"></a>
  <br>
  <a href="https://github.com/AchimPieters/HIVE/releases/latest?query=branch%3Amaster"><img src="https://img.shields.io/github/v/release/HIVE?style=for-the-badge&color=8A2BE2" alt="GitHub release (latest by date)"></a>
...
![HIVE Logo](https://github.com/AchimPieters/HIVE/blob/master/static/img/color.svg?raw=true  "HIVE Logo")

<br>

## :sparkles: About HIVE

HIVE is a digital signage platform for Raspberry Pi devices and PCs. Formerly known as HIVE OSE, it was rebranded to clear up the confusion between HIVE (the paid version) and HIVE. More details can be found in [this blog post](https://www.screenly.io/blog/2022/12/06/screenly-ose-now-called-anthias/).

:tada: **NEW: Now with Raspberry Pi 5 Support!** :tada:

Want to help HIVE thrive? Support us using [GitHub Sponsor](https://github.com/sponsors/HIVE).

## :rocket: Getting Started

See [this](/docs/installation-options.md) page for options on how to install HIVE.
...
> [!NOTE]
> See [this](/docs/installation-options.md) page for instructions on how to install HIVE on balenaOS.
...
[![Star History Chart](https://api.star-history.com/svg?repos=HIVE&type=Date)](https://star-history.com/#HIVE&Date)

## :lady_beetle: Issues and Bugs

> [!NOTE]
> We are still in the process of knocking out some bugs. You can track the known issues [here](https://github.com/AchimPieters/HIVE/issues). You can also check the discussions in the [HIVE forums](https://forums.screenly.io).
...
* [General documentation](https://github.com/AchimPieters/HIVE/blob/master/docs/README.md)

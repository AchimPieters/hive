...
<p align="center">
  <a href="https://github.com/AchimPieters/Anthias/actions/workflows/docker-test.yaml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/Screenly/Anthias/docker-test.yaml?branch=master&style=for-the-badge&label=Run%20Unit%20Tests" alt="Run Unit Tests"></a>
  <a href="https://github.com/AchimPieters/Anthias/actions/workflows/codeql-analysis.yaml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/Screenly/Anthias/codeql-analysis.yaml?branch=master&style=for-the-badge&label=CodeQL" alt="CodeQL"></a>
  <a href="https://github.com/AchimPieters/Anthias/actions/workflows/python-lint.yaml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/Screenly/Anthias/python-lint.yaml?branch=master&style=for-the-badge&label=Run%20Python%20Linter" alt="Run Python Linter"></a>
  <br>
  <a href="https://github.com/AchimPieters/Anthias/releases/latest?query=branch%3Amaster"><img src="https://img.shields.io/github/v/release/Screenly/Anthias?style=for-the-badge&color=8A2BE2" alt="GitHub release (latest by date)"></a>
...
![Anthias Logo](https://github.com/AchimPieters/Anthias/blob/master/static/img/color.svg?raw=true  "Anthias Logo")
...
> [!NOTE]
> We are still in the process of knocking out some bugs. You can track the known issues [here](https://github.com/AchimPieters/Anthias/issues). You can also check the discussions in the [Anthias forums](https://forums.screenly.io).
...
* [General documentation](https://github.com/AchimPieters/Anthias/blob/master/docs/README.md)
* [Developer documentation](https://github.com/AchimPieters/Anthias/blob/master/docs/developer-documentation.md)

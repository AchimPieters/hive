  ...
  return (
    <footer id="footer" className="bg-dark">
        ...
        <div className="row">
          <div className="col-6 small text-white mt-5 mb-5">
            <span>
              ...
              <a
                className="brand"
                href="https://www.screenly.io/?utm_source=HIVE&utm_medium=root-page&utm_campaign=UI"
                target="_blank"
                rel="noopener noreferrer"
              >
                <strong>Try HIVE</strong>
              </a>
            </span>
          </div>
          <div id="screenly-logo" className="col-12 row m-2 ms-0 me-0">
            <div className="links offset-3 col-6 text-center justify-content-center align-self-center">
              ...
              <a
                href="https://anthias.screenly.io/#faq?utm_source=HIVE&utm_medium=footer&utm_campaign=UI"
                target="_blank"
                className="me-4 small"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://screenly.io/?utm_source=HIVE&utm_medium=footer&utm_campaign=UI"
                target="_blank"
                className="me-4 small"
                rel="noopener noreferrer"
              >
            ...
            >
              ...
              >
                <img
                  ...
                  src={(() => {
                    const url = new URL(
                      'https://img.shields.io/github/stars/HIVE',
                    )
      ...
      <div className="copy pb-4">
        <div className="container">
          <div className="text-center p-2">&copy; HIVE, Inc.</div>
        </div>
      </div>
    </footer>
  )

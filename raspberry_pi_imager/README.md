...
This tool generates the JSON file used by Raspberry Pi Imager to list HIVE images.
...
```json
{
  "os_list": [
    {
      "name": "HIVE (pi1)",
      "description": "HIVE, formerly known as HIVE OSE, is the most popular open source digital signage project in the world.",
      "icon": "https://raw.githubusercontent.com/AchimPieters/HIVE/master/static/img/square-dark.svg",
      ...
      "url": "https://github.com/AchimPieters/HIVE/releases/download/v0.19.4/2024-12-23-raspberry-pi.zip"
    },
    {
      "name": "HIVE (pi2)",
      "description": "HIVE, formerly known as HIVE OSE, is the most popular open source digital signage project in the world.",
      ...
      "release_date": "2024-12-23",
      "url": "https://github.com/AchimPieters/HIVE/releases/download/v0.19.4/2024-12-23-raspberry-pi2.zip"
    },
    {
      "name": "HIVE (pi3)",
      "description": "HIVE, formerly known as HIVE OSE, is the most popular open source digital signage project in the world.",
      ...
      "release_date": "2024-12-23",
      "url": "https://github.com/AchimPieters/HIVE/releases/download/v0.19.4/2024-12-23-raspberrypi3.zip"
    },
    {
      "name": "HIVE (pi4)",
      "description": "HIVE, formerly known as HIVE OSE, is the most popular open source digital signage project in the world.",
      ...
      "release_date": "2024-12-23",
      "url": "https://github.com/AchimPieters/HIVE/releases/download/v0.19.4/2024-12-23-raspberrypi4-64.zip"
    },
    {
      "name": "HIVE (pi5)",
      "description": "HIVE, formerly known as HIVE OSE, is the most popular open source digital signage project in the world.",
      ...
      "release_date": "2024-12-23",
      "url": "https://github.com/AchimPieters/HIVE/releases/download/v0.19.4/2024-12-23-raspberrypi5.zip"
    }
  ]
}
```